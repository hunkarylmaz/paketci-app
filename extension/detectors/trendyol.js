// Paketçi Extension - Trendyol Detector

const TrendyolDetector = {
  platform: 'trendyol',
  
  isMatch() {
    return window.location.hostname.includes('trendyol.com');
  },

  detectOrders() {
    const orders = [];
    const selectors = CONSTANTS.SELECTORS.trendyol;
    ...
    containers.forEach(container => {
      try {
        ...
        console.error('[Paketçi] Trendyol parse error:', error);
      }
    });
...
window.TrendyolDetector = TrendyolDetector;
